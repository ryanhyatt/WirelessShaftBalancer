...
void loop() {
  ...
  THETA = (int) (ticks / TICKS_PER_DEGREE) % 360;
  ...
  else
  {
    ...
    //use this link to find the direction to move
    POWER = 255;
  }
  motor1.drive(POWER);
